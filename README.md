...
Nagate easy throughout the whole site with out loosing track of anything
get knowlegd about guild, members, raids, raid bosses, and classes guides.

## User stories:

As a new user the contrast with the black and yelow color is really nice.
the images on the header and body are epic every sesion ,Home,guides,raid and raider, have a different image related to the content.
...
group pictureas killing bosses.
...
As a business/home owner, I would like to find whether the designer is trustworthy and reputable by seeing what the previous clients say about them.
